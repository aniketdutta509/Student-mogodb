...
const app = express()
const url="mongodb+srv://aniket:uditdisha2@cluster0.pnobh.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
app.listen(3500,()=>console.log("EXP Server Started"))